...
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------: | :--: | :--------------------------: | :--------: | :---------------------------------------------: |
| ─── General Chat ───                                                                                                                                                                                                                                                                                                    |
| [GroupGPT: A Token-efficient and Privacy-preserving Agentic Framework for Multi-User Chat Assistant](https://arxiv.org/abs/2603.01059)                                                                                                                                                                                  |   arXiv    | 2026 | image,video,audio,emoji,text |    text    | [Code](https://github.com/Eliot-Shen/GroupGPT)  |
...
| [Adaptive Friend Agent: Personalized Multi-User Memory for Conversational AI](https://openreview.net/pdf?id=wKTwm7ZzDK)                                                                                                                                                                                                 | openreview | 2026 |            audio             |   audio    |                                                 |
...
| [Social-RAG: Retrieving from Group Interactions to Socially Ground AI Generation](https://arxiv.org/abs/2503.12757)                                                                                                                                                                                                     |    CHI     | 2025 |             text             | text, link |                                                 |
| ─── Other type ───                                                                                                                                                                                                                                                                                                      |
...
| [AgentGroupChat: An Interactive Group Chat Simulacra For Better Eliciting Emergent Behavior](https://arxiv.org/abs/2403.13433)                                                                                                                                                                                          |   arXiv    | 2024 |                              |            | [Code](https://github.com/MikeGu721/AgentGroup) |

### Datasets

| Name             | Year | Link                                                                         | Notes |
| ---------------- | ---- | ---------------------------------------------------------------------------- | ----- |
| MUIR             | 2026 | [GitHub](https://github.com/hsp-iit/concon-chi_benchmark?tab=readme-ov-file) |       |
